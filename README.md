...
│                        开发者侧                              │
│  ┌──────────────────┐                                       │
│  │  AbilityConsole  │  ← 开发者 IDE，上传/管理 Skill         │
│  └────────┬─────────┘                                       │
└───────────┼─────────────────────────────────────────────────┘
            │
            ▼
...
| 服务 | 职责 |
|------|------|
| **AbilityConsole** | 开发者工作台，Skill 上传、管理、Agent 绑定 |
| **HAGManager** | 管理后台，Skill 审核、发布、下架 |
...
├── openapi-ability-console.yaml   # AbilityConsole API 规范
├── openapi-hag-manager.yaml       # HAGManager API 规范
...
- `openapi-ability-console.yaml` - 开发者侧 API（Skill 管理、Agent 绑定）
- `openapi-hag-manager.yaml` - 管理侧 API（审核流程）
...
1. **Phase 1**: 基础设施搭建
2. **Phase 2**: AbilityConsole Skill 管理
3. **Phase 3**: 服务间同步机制
4. **Phase 4**: HAGManager 审核功能
